...
const Interview = () => {
    ...
    const interviewId = params.interviewId || params.interviewID
        ...
        return (
            <main className='loading-screen'>
                <div className='loader-container'>
                    ...
                    <p className='loading-text'>Loading plan</p>
                </div>
            </main>
        )
    }
    ...
    return (
        <div className='interview-page'>
            <div className='interview-page__topbar'>
                <button className='button back-button' onClick={handleGoHome}>
                    ← Back
                </button>
            </div>
