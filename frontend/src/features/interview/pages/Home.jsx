...
const Home = () => {
    ...
    const handleFileChange = (e) => {
        if (e.target.files && e.target.files[0]) {
            ...
            setNotification(`✓ ${fileName} uploaded successfully`)
            setIsExiting(false)
        ...
        return (
            <main className='loading-screen'>
                <div className='loader-container'>
                    ...
                    <p className='loading-text'>Creating your plan</p>
                </div>
            </main>
        )
    }
    ...
    return (
        <div className='home-page'>
            {/* Notification Toast */}
            {notification && (
                <div className={`notification-toast ${isExiting ? 'show-exit' : ''}`}>
                    <span className='notification-toast__icon'>✓</span>
                    <p className='notification-toast__message'>{notification}</p>
                </div>
            )}
